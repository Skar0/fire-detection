    ...
    while video.isOpened():
        ...
        if not_done:
            ...
            if frame_nbr % detection_freq != 0:
                ...
                # transform [0,1] values into percentages and associate it to its class name (class_name order was used
